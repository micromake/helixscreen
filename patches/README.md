...
| `lvgl-drm-flush-rotation.patch` | `lv_linux_drm.c`, `.h` | DRM plane rotation API + 180° software rotation via shadow buffer in flush callback + legacy `drmModeSetCrtc` fallback when atomic commit fails |
